...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <a href="{{ route('kasir.dashboard') }}" class="nav-item active">
        ...
        <div class="chart-card">
          ...
          <div class="chart-body">
            ...
            <div class="chart-plot">
              <div class="chart-bars-area" id="chartBars" style="height:340px;">
                <!-- bars injected by JS -->
              </div>
