  ...
  <main class="main">
    <div class="topbar">
      <div class="search-wrap">
        ...
        <input class="search-input" type="text" placeholder="Cari meja ...">
      </div>
    ...
    <div class="content">
      <div class="page-header">
        ...
        <button class="btn-primary" onclick="openModal('addMejaModal')">+ Tambah Meja Baru</button>
      </div>
...
<!-- Tambah Meja Modal -->
<div id="addMejaModal" class="modal-overlay hidden">
