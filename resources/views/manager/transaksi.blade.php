    ...
    <div class="content">
      <div class="page-header">
        <div class="page-header-left">
          ...
          <p>Kelola dan pantau semua aktivitas transaksi penjualan harian Anda.</p>
        </div>
      </div>
