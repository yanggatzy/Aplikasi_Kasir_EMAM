  ...
  <main class="main">
    <div class="topbar">
      <div class="search-wrap">
        ...
        <input class="search-input" type="text" placeholder="Cari kategori ...">
      </div>
    ...
    <div class="content">
      <div class="page-header">
        <div class="page-header-left">
          ...
          <p>Kelola pengelompokan menu restoran Anda untuk efisiensi operasional.</p>
        </div>
        <button class="btn-primary" onclick="openModal('addKategoriModal')">
...
<div id="addKategoriModal" class="modal-overlay hidden">
