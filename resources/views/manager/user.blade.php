...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('manager.laporan') }}" class="nav-item"><svg width="18" height="22" viewBox="0 0 18 22" fill="none"><path d="M6 16H12V14H6V16ZM6 12H12V10H6V12ZM4 20C3.45 20 2.97917 19.8042 2.5875 19.4125C2.19583 19.0208 2 18.55 2 18V4C2 3.45 2.19583 2.97917 2.5875 2.5875C2.97917 2.19583 3.45 2 4 2H10L16 8V18C16 18.55 15.8042 19.0208 15.4125 19.4125C15.0208 19.8042 14.55 20 14 20H4ZM9 9V4H4V18H14V9H9Z" fill="#594238"/></svg><span>Laporan</span></a>
    </nav>
  ...
  <main class="main">
    <div class="topbar">
      <div class="search-wrap">
        ...
        <input class="search-input" type="text" placeholder="Cari user ...">
      </div>
    ...
    <div class="content">
      <div class="page-header">
        <div class="page-header-left">
          <h1>Tambah User</h1>
          <p>Kelola akses dan akun staf restoran Anda</p>
        </div>
        <button class="btn-primary" onclick="openModal('addUserModal')">+ Tambah Kasir Baru</button>
      </div>
