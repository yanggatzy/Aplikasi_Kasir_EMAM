...
<head>
  ...
  <title>Detail Laporan - Emam Manager</title>
  <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
  @vite(['resources/css/manager.css', 'resources/js/manager-detail-laporan.js'])
</head>
<body>
<div class="app">
  ...
  <main class="main">
    ...
    <div class="content">
      <!-- Breadcrumb -->
      <a href="{{ route('manager.laporan') }}" class="breadcrumb">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M20 11H7.83L13.42 5.41L12 4L4 12L12 20L13.41 18.59L7.83 13H20V11Z" fill="#D35400"/></svg>
        Kembali ke Laporan
      </a>
